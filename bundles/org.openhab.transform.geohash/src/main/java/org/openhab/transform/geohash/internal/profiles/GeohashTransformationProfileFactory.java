...
public class GeohashTransformationProfileFactory implements ProfileFactory, ProfileTypeProvider {
    ...
    public @Nullable Profile createProfile(ProfileTypeUID profileTypeUID, ProfileCallback callback,
        ...
        return new GeohashTransformationProfile(callback, profileContext, service);
    }
