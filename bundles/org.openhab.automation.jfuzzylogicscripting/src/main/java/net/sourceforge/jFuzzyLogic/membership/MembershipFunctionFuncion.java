...
public class MembershipFunctionFuncion extends MembershipFunctionDiscrete {
     ...
     * @return A tree of MffFunctions. Each leave can be either a function, a value (Double), a Variable or a Variable's
     *         name.
     */
    ...
    public double valueX(int index) {
        if (index == 0) {
            ...
            Gpr.debug("Evaluation: " + function + "\t=>\t" + eval);
