...
public class FclParser extends Parser {
    public static final String[] tokenNames = new String[] { "<invalid>", "<EOR>", "<DOWN>", "<UP>", "POINT", "FCL",
            "VALUE_REAL", "VALUE_ID", "ABS", "ACCU", "ACT", "AND", "ASUM", "BDIF", "BSUM", "COA", "COSINE", "COG",
            "COGS", "COGF", "COS", "DEFAULT", "DEFUZZIFY", "DMAX", "DMIN", "DSIGM", "EINSTEIN", "END_DEFUZZIFY",
            "END_FUNCTION_BLOCK", "END_FUZZIFY", "END_RULEBLOCK", "END_VAR", "EXP", "HAMACHER", "FUNCTION", "GAUSS",
            "GAUSS2", "GBELL", "FUNCTION_BLOCK", "FUZZIFY", "IF", "IS", "LM", "LN", "LOG", "MAX", "METHOD", "MIN",
            "NIPMIN", "NIPMAX", "MM", "NC", "NOT", "NSUM", "OR", "PROBOR", "PROD", "RANGE", "RM", "RULE", "RULEBLOCK",
            "SIGM", "SIN", "SINGLETONS", "SUM", "TAN", "TERM", "THEN", "TRAPE", "TRIAN", "TYPE_REAL", "VAR_INPUT",
            "VAR_OUTPUT", "WITH", "WS", "NEWLINE", "ASSIGN_OPERATOR", "COLON", "COMMA", "DOT", "DOTS", "HAT",
            "LEFT_CURLY", "LEFT_PARENTHESIS", "MINUS", "PERCENT", "PLUS", "RIGHT_CURLY", "RIGHT_PARENTHESIS",
            "SEMICOLON", "SLASH", "STAR", "DIGIT", "NUMBER", "LOWER", "UPPER", "LETTER", "ALPHANUM", "REAL", "COMMENT",
    ...
    public final FclParser.main_return main() throws RecognitionException {
        ...
        try {
            ...
            // Fcl.g:167:8: f= fcl
            {
                ...
                // rule list labels:
                retval.tree = root_0;
                RewriteRuleSubtreeStream stream_f = new RewriteRuleSubtreeStream(adaptor, "token f", f.tree);
                ...
                // 167:14: -> ^( FCL $f)
                {
                    // Fcl.g:167:17: ^( FCL $f)
                    {
                        ...
                        root_1 = adaptor.becomeRoot(adaptor.create(FCL, "FCL"), root_1);
    ...
    public final FclParser.function_block_return function_block() throws RecognitionException {
        ...
        try {
            ...
            // Fcl.g:171:18: FUNCTION_BLOCK ( ID )? ( declaration )* END_FUNCTION_BLOCK
            {
                ...
                FUNCTION_BLOCK2_tree = adaptor.create(FUNCTION_BLOCK2);
                root_0 = adaptor.becomeRoot(FUNCTION_BLOCK2_tree, root_0);
                ...
                loop3: do {
                    ...
                    if ((LA3_0 == DEFUZZIFY || LA3_0 == FUZZIFY || LA3_0 == RULEBLOCK
                            || (LA3_0 >= VAR_INPUT && LA3_0 <= VAR_OUTPUT))) {
                        alt3 = 1;
                    }
                ...
                END_FUNCTION_BLOCK5 = (Token) match(input, END_FUNCTION_BLOCK,
                        FOLLOW_END_FUNCTION_BLOCK_in_function_block2626);
    ...
    public final FclParser.var_input_return var_input() throws RecognitionException {
        ...
        try {
            ...
            // Fcl.g:175:13: VAR_INPUT ( var_def )* END_VAR
            {
                ...
                VAR_INPUT11_tree = adaptor.create(VAR_INPUT11);
                root_0 = adaptor.becomeRoot(VAR_INPUT11_tree, root_0);
    ...
    public final FclParser.var_output_return var_output() throws RecognitionException {
        ...
        try {
            ...
            // Fcl.g:176:14: VAR_OUTPUT ( var_def )+ END_VAR
            {
                ...
                VAR_OUTPUT14_tree = adaptor.create(VAR_OUTPUT14);
                root_0 = adaptor.becomeRoot(VAR_OUTPUT14_tree, root_0);
    ...
    public final FclParser.var_def_return var_def() throws RecognitionException {
        ...
        try {
            ...
            // Fcl.g:177:11: ID COLON data_type SEMICOLON ( range )?
            {
                ...
                ID17_tree = adaptor.create(ID17);
                root_0 = adaptor.becomeRoot(ID17_tree, root_0);
    ...
    public final FclParser.fuzzify_block_return fuzzify_block() throws RecognitionException {
        ...
        try {
            ...
            // Fcl.g:180:17: FUZZIFY ID ( linguistic_term )* END_FUZZIFY
            {
                ...
                FUZZIFY22_tree = adaptor.create(FUZZIFY22);
                root_0 = adaptor.becomeRoot(FUZZIFY22_tree, root_0);

                ID23 = (Token) match(input, ID, FOLLOW_ID_in_fuzzify_block2719);
                ID23_tree = adaptor.create(ID23);
    ...
    public final FclParser.linguistic_term_return linguistic_term() throws RecognitionException {
        ...
        try {
            ...
            // Fcl.g:181:18: TERM ID ASSIGN_OPERATOR membership_function SEMICOLON
            {
                ...
                TERM26_tree = adaptor.create(TERM26);
                root_0 = adaptor.becomeRoot(TERM26_tree, root_0);

                ID27 = (Token) match(input, ID, FOLLOW_ID_in_linguistic_term2736);
                ID27_tree = adaptor.create(ID27);
                adaptor.addChild(root_0, ID27_tree);

                ASSIGN_OPERATOR28 = (Token) match(input, ASSIGN_OPERATOR,
                        FOLLOW_ASSIGN_OPERATOR_in_linguistic_term2738);
    ...
    // Fcl.g:182:1: membership_function : ( function | singleton | singletons | piece_wise_linear | gauss | gauss2 |
    // trian | trape | sigm | gbell | cosine | dsigm );
    public final FclParser.membership_function_return membership_function() throws RecognitionException {
        ...
        try {
            // Fcl.g:182:21: ( function | singleton | singletons | piece_wise_linear | gauss | gauss2 | trian | trape |
    ...
    public final FclParser.cosine_return cosine() throws RecognitionException {
        ...
        try {
            ...
            // Fcl.g:183:9: COSINE atom atom
            {
                ...
                COSINE43_tree = adaptor.create(COSINE43);
                root_0 = adaptor.becomeRoot(COSINE43_tree, root_0);
    ...
    public final FclParser.dsigm_return dsigm() throws RecognitionException {
        ...
        try {
            ...
            // Fcl.g:184:8: DSIGM atom atom atom atom
            {
                ...
                DSIGM46_tree = adaptor.create(DSIGM46);
                root_0 = adaptor.becomeRoot(DSIGM46_tree, root_0);
    ...
    public final FclParser.gauss_return gauss() throws RecognitionException {
        ...
        try {
            ...
            // Fcl.g:185:8: GAUSS atom atom
            {
                ...
                GAUSS51_tree = adaptor.create(GAUSS51);
                root_0 = adaptor.becomeRoot(GAUSS51_tree, root_0);
    ...
    public final FclParser.gauss2_return gauss2() throws RecognitionException {
        ...
        try {
            ...
            // Fcl.g:186:9: GAUSS2 atom atom atom atom
            {
                ...
                GAUSS254_tree = adaptor.create(GAUSS254);
                root_0 = adaptor.becomeRoot(GAUSS254_tree, root_0);
    ...
    public final FclParser.gbell_return gbell() throws RecognitionException {
        ...
        try {
            ...
            // Fcl.g:187:8: GBELL atom atom atom
            {
                ...
                GBELL59_tree = adaptor.create(GBELL59);
                root_0 = adaptor.becomeRoot(GBELL59_tree, root_0);
    ...
    public final FclParser.sigm_return sigm() throws RecognitionException {
        ...
        try {
            ...
            // Fcl.g:189:7: SIGM atom atom
            {
                ...
                SIGM64_tree = adaptor.create(SIGM64);
                root_0 = adaptor.becomeRoot(SIGM64_tree, root_0);
    ...
    public final FclParser.singletons_return singletons() throws RecognitionException {
        ...
        try {
            ...
            // Fcl.g:191:13: SINGLETONS ( points )+
            {
                ...
                SINGLETONS68_tree = adaptor.create(SINGLETONS68);
                root_0 = adaptor.becomeRoot(SINGLETONS68_tree, root_0);
    ...
    public final FclParser.trape_return trape() throws RecognitionException {
        ...
        try {
            ...
            // Fcl.g:192:8: TRAPE atom atom atom atom
            {
                ...
                TRAPE70_tree = adaptor.create(TRAPE70);
                root_0 = adaptor.becomeRoot(TRAPE70_tree, root_0);
    ...
    public final FclParser.trian_return trian() throws RecognitionException {
        ...
        try {
            ...
            // Fcl.g:193:8: TRIAN atom atom atom
            {
                ...
                TRIAN75_tree = adaptor.create(TRIAN75);
                root_0 = adaptor.becomeRoot(TRIAN75_tree, root_0);
    ...
    public final FclParser.points_return points() throws RecognitionException {
        ...
        RewriteRuleTokenStream stream_RIGHT_PARENTHESIS = new RewriteRuleTokenStream(adaptor,
        ...
        try {
            ...
            // Fcl.g:194:10: LEFT_PARENTHESIS x= atom COMMA y= atom RIGHT_PARENTHESIS
            {
                ...
                RewriteRuleSubtreeStream stream_retval = new RewriteRuleSubtreeStream(adaptor, "token retval",
                        retval != null ? retval.tree : null);
                RewriteRuleSubtreeStream stream_y = new RewriteRuleSubtreeStream(adaptor, "token y",
                        y != null ? y.tree : null);
                RewriteRuleSubtreeStream stream_x = new RewriteRuleSubtreeStream(adaptor, "token x",
                        x != null ? x.tree : null);
                ...
                // 194:65: -> ^( POINT $x $y)
                {
                    ...
                    {
                        Object root_1 = adaptor.nil();
                        root_1 = adaptor.becomeRoot(adaptor.create(POINT, "POINT"), root_1);
        ...
        try {
            ...
            // Fcl.g:196:7: x= ID
            {
                ...
                // 196:13: -> ^( VALUE_ID $x)
                {
                    ...
                    {
                        Object root_1 = adaptor.nil();
                        root_1 = adaptor.becomeRoot(adaptor.create(VALUE_ID, "VALUE_ID"), root_1);
        ...
        try {
            ...
            // Fcl.g:197:9: x= REAL
            {
                ...
                // 197:17: -> ^( VALUE_REAL $x)
                {
                    ...
                    {
                        Object root_1 = adaptor.nil();
                        root_1 = adaptor.becomeRoot(adaptor.create(VALUE_REAL, "VALUE_REAL"), root_1);
    ...
    public final FclParser.function_return function() throws RecognitionException {
        ...
        try {
            ...
            // Fcl.g:200:11: FUNCTION fun_pm
            {
                ...
                FUNCTION84_tree = adaptor.create(FUNCTION84);
                root_0 = adaptor.becomeRoot(FUNCTION84_tree, root_0);
                        ...
                        // Fcl.g:201:17: ( PLUS | MINUS ) fun_md
                        {
                            ...
                            switch (alt13) {
                                ...
                                // Fcl.g:201:18: PLUS
                                {
                                    ...
                                    PLUS87_tree = adaptor.create(PLUS87);
                                    root_0 = adaptor.becomeRoot(PLUS87_tree, root_0);
                                ...
                                // Fcl.g:201:26: MINUS
                                {
                                    ...
                                    MINUS88_tree = adaptor.create(MINUS88);
                                    root_0 = adaptor.becomeRoot(MINUS88_tree, root_0);
                        ...
                        // Fcl.g:202:17: ( STAR | SLASH ) fun_mp
                        {
                            ...
                            switch (alt15) {
                                ...
                                // Fcl.g:202:18: STAR
                                {
                                    ...
                                    STAR91_tree = adaptor.create(STAR91);
                                    root_0 = adaptor.becomeRoot(STAR91_tree, root_0);
                                ...
                                // Fcl.g:202:26: SLASH
                                {
                                    ...
                                    SLASH92_tree = adaptor.create(SLASH92);
                                    root_0 = adaptor.becomeRoot(SLASH92_tree, root_0);
                        ...
                        // Fcl.g:203:20: ( HAT | PERCENT ) fun_atom
                        {
                            ...
                            switch (alt17) {
                                ...
                                // Fcl.g:203:21: HAT
                                {
                                    ...
                                    HAT95_tree = adaptor.create(HAT95);
                                    root_0 = adaptor.becomeRoot(HAT95_tree, root_0);
                                ...
                                // Fcl.g:203:28: PERCENT
                                {
                                    ...
                                    PERCENT96_tree = adaptor.create(PERCENT96);
                                    root_0 = adaptor.becomeRoot(PERCENT96_tree, root_0);
    ...
    // Fcl.g:204:1: fun_atom : ( atom | ( EXP | LN | LOG | SIN | COS | TAN | ABS )? LEFT_PARENTHESIS fun_pm
    // RIGHT_PARENTHESIS );
    public final FclParser.fun_atom_return fun_atom() throws RecognitionException {
        ...
        try {
            // Fcl.g:204:10: ( atom | ( EXP | LN | LOG | SIN | COS | TAN | ABS )? LEFT_PARENTHESIS fun_pm
            // RIGHT_PARENTHESIS )
            int alt20 = 2;
            ...
            if ((LA20_0 == REAL || LA20_0 == ID)) {
                alt20 = 1;
            } else if ((LA20_0 == ABS || LA20_0 == COS || LA20_0 == EXP || (LA20_0 >= LN && LA20_0 <= LOG)
                    || LA20_0 == SIN || LA20_0 == TAN || LA20_0 == LEFT_PARENTHESIS)) {
                alt20 = 2;
            } else {
                ...
                // Fcl.g:204:19: ( EXP | LN | LOG | SIN | COS | TAN | ABS )? LEFT_PARENTHESIS fun_pm RIGHT_PARENTHESIS
                {
                    ...
                    switch (alt19) {
                        ...
                        // Fcl.g:204:20: EXP
                        {
                            ...
                            EXP99_tree = adaptor.create(EXP99);
                            root_0 = adaptor.becomeRoot(EXP99_tree, root_0);
                        ...
                        // Fcl.g:204:25: LN
                        {
                            ...
                            LN100_tree = adaptor.create(LN100);
                            root_0 = adaptor.becomeRoot(LN100_tree, root_0);
                        ...
                        // Fcl.g:204:29: LOG
                        {
                            ...
                            LOG101_tree = adaptor.create(LOG101);
                            root_0 = adaptor.becomeRoot(LOG101_tree, root_0);
                        ...
                        // Fcl.g:204:34: SIN
                        {
                            ...
                            SIN102_tree = adaptor.create(SIN102);
                            root_0 = adaptor.becomeRoot(SIN102_tree, root_0);
                        ...
                        // Fcl.g:204:39: COS
                        {
                            ...
                            COS103_tree = adaptor.create(COS103);
                            root_0 = adaptor.becomeRoot(COS103_tree, root_0);
                        ...
                        // Fcl.g:204:44: TAN
                        {
                            ...
                            TAN104_tree = adaptor.create(TAN104);
                            root_0 = adaptor.becomeRoot(TAN104_tree, root_0);
                        ...
                        // Fcl.g:204:49: ABS
                        {
                            ...
                            ABS105_tree = adaptor.create(ABS105);
                            root_0 = adaptor.becomeRoot(ABS105_tree, root_0);
                    ...
                    LEFT_PARENTHESIS106 = (Token) match(input, LEFT_PARENTHESIS,
                            FOLLOW_LEFT_PARENTHESIS_in_fun_atom3137);
                    ...
                    RIGHT_PARENTHESIS108 = (Token) match(input, RIGHT_PARENTHESIS,
                            FOLLOW_RIGHT_PARENTHESIS_in_fun_atom3142);
    ...
    public final FclParser.defuzzify_block_return defuzzify_block() throws RecognitionException {
        ...
        try {
            ...
            // Fcl.g:207:19: DEFUZZIFY ID ( defuzzify_item )* END_DEFUZZIFY
            {
                ...
                DEFUZZIFY109_tree = adaptor.create(DEFUZZIFY109);
                root_0 = adaptor.becomeRoot(DEFUZZIFY109_tree, root_0);

                ID110 = (Token) match(input, ID, FOLLOW_ID_in_defuzzify_block3156);
                ID110_tree = adaptor.create(ID110);
    ...
    public final FclParser.range_return range() throws RecognitionException {
        ...
        try {
            ...
            // Fcl.g:209:9: RANGE ASSIGN_OPERATOR LEFT_PARENTHESIS REAL DOTS REAL RIGHT_PARENTHESIS SEMICOLON
            {
                ...
                RANGE117_tree = adaptor.create(RANGE117);
                root_0 = adaptor.becomeRoot(RANGE117_tree, root_0);
                ...
                REAL120_tree = adaptor.create(REAL120);
                ...
                REAL122_tree = adaptor.create(REAL122);
    ...
    public final FclParser.defuzzification_method_return defuzzification_method() throws RecognitionException {
        ...
        try {
            ...
            // Fcl.g:210:26: METHOD COLON ( COG | COGS | COGF | COA | LM | RM | MM ) SEMICOLON
            {
                ...
                METHOD125_tree = adaptor.create(METHOD125);
                root_0 = adaptor.becomeRoot(METHOD125_tree, root_0);

                COLON126 = (Token) match(input, COLON, FOLLOW_COLON_in_defuzzification_method3220);
                set127 = input.LT(1);
                if (input.LA(1) == COA || (input.LA(1) >= COG && input.LA(1) <= COGF) || input.LA(1) == LM
                        || input.LA(1) == MM || input.LA(1) == RM) {
                    input.consume();
    ...
    public final FclParser.default_value_return default_value() throws RecognitionException {
        ...
        try {
            ...
            // Fcl.g:211:17: DEFAULT ASSIGN_OPERATOR ( REAL | NC ) SEMICOLON
            {
                ...
                DEFAULT129_tree = adaptor.create(DEFAULT129);
                root_0 = adaptor.becomeRoot(DEFAULT129_tree, root_0);
                ...
                if (input.LA(1) == NC || input.LA(1) == REAL) {
                    input.consume();
                    adaptor.addChild(root_0, adaptor.create(set131));
                    state.errorRecovery = false;
                } else {
                    MismatchedSetException mse = new MismatchedSetException(null, input);
                    throw mse;
    ...
    public final FclParser.rule_block_return rule_block() throws RecognitionException {
        ...
        try {
            ...
            // Fcl.g:214:14: RULEBLOCK ID ( rule_item )* END_RULEBLOCK
            {
                ...
                RULEBLOCK133_tree = adaptor.create(RULEBLOCK133);
                root_0 = adaptor.becomeRoot(RULEBLOCK133_tree, root_0);

                ID134 = (Token) match(input, ID, FOLLOW_ID_in_rule_block3274);
                ID134_tree = adaptor.create(ID134);
    ...
    public final FclParser.operator_definition_or_return operator_definition_or() throws RecognitionException {
        ...
        try {
            ...
            // Fcl.g:217:26: OR COLON ( MAX | ASUM | BSUM | DMAX | NIPMAX | EINSTEIN ) SEMICOLON
            {
                ...
                OR143_tree = adaptor.create(OR143);
                root_0 = adaptor.becomeRoot(OR143_tree, root_0);

                COLON144 = (Token) match(input, COLON, FOLLOW_COLON_in_operator_definition_or3322);
                set145 = input.LT(1);
                if (input.LA(1) == ASUM || input.LA(1) == BSUM || input.LA(1) == DMAX || input.LA(1) == EINSTEIN
                        || input.LA(1) == MAX || input.LA(1) == NIPMAX) {
                    input.consume();
                    adaptor.addChild(root_0, adaptor.create(set145));
                    state.errorRecovery = false;
                } else {
                    MismatchedSetException mse = new MismatchedSetException(null, input);
                    throw mse;
    ...
    public final FclParser.operator_definition_and_return operator_definition_and() throws RecognitionException {
        ...
        try {
            ...
            // Fcl.g:218:27: AND COLON ( MIN | PROD | BDIF | DMIN | NIPMIN | HAMACHER ) SEMICOLON
            {
                ...
                AND147_tree = adaptor.create(AND147);
                root_0 = adaptor.becomeRoot(AND147_tree, root_0);

                COLON148 = (Token) match(input, COLON, FOLLOW_COLON_in_operator_definition_and3350);
                set149 = input.LT(1);
                if (input.LA(1) == BDIF || input.LA(1) == DMIN || input.LA(1) == HAMACHER
                        || (input.LA(1) >= MIN && input.LA(1) <= NIPMIN) || input.LA(1) == PROD) {
                    input.consume();
                    adaptor.addChild(root_0, adaptor.create(set149));
                    state.errorRecovery = false;
                } else {
                    MismatchedSetException mse = new MismatchedSetException(null, input);
                    throw mse;
    ...
    public final FclParser.activation_method_return activation_method() throws RecognitionException {
        ...
        try {
            ...
            // Fcl.g:219:21: ACT COLON ( PROD | MIN ) SEMICOLON
            {
                ...
                ACT151_tree = adaptor.create(ACT151);
                root_0 = adaptor.becomeRoot(ACT151_tree, root_0);

                COLON152 = (Token) match(input, COLON, FOLLOW_COLON_in_activation_method3378);
                set153 = input.LT(1);
                if (input.LA(1) == MIN || input.LA(1) == PROD) {
                    input.consume();
                    adaptor.addChild(root_0, adaptor.create(set153));
                    state.errorRecovery = false;
                } else {
                    MismatchedSetException mse = new MismatchedSetException(null, input);
                    throw mse;
    ...
    public final FclParser.accumulation_method_return accumulation_method() throws RecognitionException {
        ...
        try {
            ...
            // Fcl.g:220:23: ACCU COLON ( MAX | BSUM | NSUM | PROBOR | SUM ) SEMICOLON
            {
                ...
                ACCU155_tree = adaptor.create(ACCU155);
                root_0 = adaptor.becomeRoot(ACCU155_tree, root_0);

                COLON156 = (Token) match(input, COLON, FOLLOW_COLON_in_accumulation_method3398);
                set157 = input.LT(1);
                if (input.LA(1) == BSUM || input.LA(1) == MAX || input.LA(1) == NSUM || input.LA(1) == PROBOR
                        || input.LA(1) == SUM) {
                    input.consume();
    ...
    public final FclParser.rule_return rule() throws RecognitionException {
        ...
        try {
            ...
            // Fcl.g:221:8: RULE rule_name COLON if_clause then_clause ( with )? SEMICOLON
            {
                ...
                RULE159_tree = adaptor.create(RULE159);
                root_0 = adaptor.becomeRoot(RULE159_tree, root_0);
        ...
        try {
            ...
            // Fcl.g:
            {
                ...
                if (input.LA(1) == REAL || input.LA(1) == ID) {
                    input.consume();
                    adaptor.addChild(root_0, adaptor.create(set166));
                    state.errorRecovery = false;
                } else {
                    MismatchedSetException mse = new MismatchedSetException(null, input);
                    throw mse;
    ...
    public final FclParser.if_clause_return if_clause() throws RecognitionException {
        ...
        try {
            ...
            // Fcl.g:223:13: IF condition
            {
                ...
                IF167_tree = adaptor.create(IF167);
                root_0 = adaptor.becomeRoot(IF167_tree, root_0);
    ...
    public final FclParser.then_clause_return then_clause() throws RecognitionException {
        ...
        try {
            ...
            // Fcl.g:224:15: THEN conclusion
            {
                ...
                THEN169_tree = adaptor.create(THEN169);
                root_0 = adaptor.becomeRoot(THEN169_tree, root_0);
                        ...
                        // Fcl.g:225:27: ( AND | OR ) subcondition
                        {
                            ...
                            switch (alt27) {
                                ...
                                // Fcl.g:225:28: AND
                                {
                                    ...
                                    AND172_tree = adaptor.create(AND172);
                                    root_0 = adaptor.becomeRoot(AND172_tree, root_0);
                                ...
                                // Fcl.g:225:33: OR
                                {
                                    ...
                                    OR173_tree = adaptor.create(OR173);
                                    root_0 = adaptor.becomeRoot(OR173_tree, root_0);
            ...
            // Fcl.g:226:16: ( NOT )? ( subcondition_bare | subcondition_paren )
            {
                ...
                switch (alt29) {
                    ...
                    // Fcl.g:226:17: NOT
                    {
                        ...
                        NOT175_tree = adaptor.create(NOT175);
                        root_0 = adaptor.becomeRoot(NOT175_tree, root_0);
    ...
    public final FclParser.subcondition_bare_return subcondition_bare() throws RecognitionException {
        ...
        try {
            ...
            // Fcl.g:227:21: ID ( IS ( NOT )? ID )?
            {
                ...
                ID178_tree = adaptor.create(ID178);
                root_0 = adaptor.becomeRoot(ID178_tree, root_0);
                    ...
                    // Fcl.g:227:26: IS ( NOT )? ID
                    {
                        ...
                        switch (alt31) {
                            ...
                            // Fcl.g:227:31: NOT
                            {
                                ...
                                NOT180_tree = adaptor.create(NOT180);
                        ...
                        ID181_tree = adaptor.create(ID181);
    ...
    public final FclParser.subcondition_paren_return subcondition_paren() throws RecognitionException {
        ...
        try {
            ...
            // Fcl.g:228:22: LEFT_PARENTHESIS condition RIGHT_PARENTHESIS
            {
                ...
                LEFT_PARENTHESIS182 = (Token) match(input, LEFT_PARENTHESIS,
                        FOLLOW_LEFT_PARENTHESIS_in_subcondition_paren3539);
                LEFT_PARENTHESIS182_tree = adaptor.create(LEFT_PARENTHESIS182);
                root_0 = adaptor.becomeRoot(LEFT_PARENTHESIS182_tree, root_0);
                ...
                RIGHT_PARENTHESIS184 = (Token) match(input, RIGHT_PARENTHESIS,
                        FOLLOW_RIGHT_PARENTHESIS_in_subcondition_paren3544);
    ...
    public final FclParser.with_return with() throws RecognitionException {
        ...
        try {
            ...
            // Fcl.g:231:7: WITH REAL
            {
                ...
                WITH191_tree = adaptor.create(WITH191);
                root_0 = adaptor.becomeRoot(WITH191_tree, root_0);

                REAL192 = (Token) match(input, REAL, FOLLOW_REAL_in_with3582);
                REAL192_tree = adaptor.create(REAL192);
    ...
    public final FclParser.data_type_return data_type() throws RecognitionException {
        ...
        try {
            ...
            // Fcl.g:234:13: TYPE_REAL
            {
                ...
                TYPE_REAL193_tree = adaptor.create(TYPE_REAL193);
    ...
    public static final BitSet FOLLOW_FUNCTION_BLOCK_in_function_block2613 = new BitSet(
            new long[] { 0x1000008010400000L, 0x0000004000000180L });
    public static final BitSet FOLLOW_ID_in_function_block2617 = new BitSet(
            new long[] { 0x1000008010400000L, 0x0000000000000180L });
    public static final BitSet FOLLOW_declaration_in_function_block2622 = new BitSet(
            new long[] { 0x1000008010400000L, 0x0000000000000180L });
    public static final BitSet FOLLOW_END_FUNCTION_BLOCK_in_function_block2626 = new BitSet(
    ...
    public static final BitSet FOLLOW_defuzzify_block_in_declaration2647 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_rule_block_in_declaration2651 = new BitSet(new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_VAR_INPUT_in_var_input2660 = new BitSet(
            new long[] { 0x0000000080000000L, 0x0000004000000000L });
    public static final BitSet FOLLOW_var_def_in_var_input2664 = new BitSet(
            new long[] { 0x0000000080000000L, 0x0000004000000000L });
    public static final BitSet FOLLOW_END_VAR_in_var_input2668 = new BitSet(new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_VAR_OUTPUT_in_var_output2676 = new BitSet(
            new long[] { 0x0000000080000000L, 0x0000004000000000L });
    public static final BitSet FOLLOW_var_def_in_var_output2680 = new BitSet(
            new long[] { 0x0000000080000000L, 0x0000004000000000L });
    public static final BitSet FOLLOW_END_VAR_in_var_output2684 = new BitSet(new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_ID_in_var_def2692 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000000002000L });
    public static final BitSet FOLLOW_COLON_in_var_def2695 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000000000040L });
    public static final BitSet FOLLOW_data_type_in_var_def2698 = new BitSet(
    ...
    public static final BitSet FOLLOW_FUZZIFY_in_fuzzify_block2716 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004000000000L });
    public static final BitSet FOLLOW_ID_in_fuzzify_block2719 = new BitSet(
            new long[] { 0x0000000020000000L, 0x0000000000000004L });
    public static final BitSet FOLLOW_linguistic_term_in_fuzzify_block2722 = new BitSet(
            new long[] { 0x0000000020000000L, 0x0000000000000004L });
    public static final BitSet FOLLOW_END_FUZZIFY_in_fuzzify_block2726 = new BitSet(new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_TERM_in_linguistic_term2733 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004000000000L });
    public static final BitSet FOLLOW_ID_in_linguistic_term2736 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000000001000L });
    public static final BitSet FOLLOW_ASSIGN_OPERATOR_in_linguistic_term2738 = new BitSet(
            new long[] { 0xA000003C02010000L, 0x0000004400080030L });
    public static final BitSet FOLLOW_membership_function_in_linguistic_term2741 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000002000000L });
    public static final BitSet FOLLOW_SEMICOLON_in_linguistic_term2743 = new BitSet(new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_function_in_membership_function2751 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_singleton_in_membership_function2755 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_singletons_in_membership_function2759 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_piece_wise_linear_in_membership_function2763 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_gauss_in_membership_function2767 = new BitSet(new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_gauss2_in_membership_function2771 = new BitSet(
            new long[] { 0x0000000000000002L });
    ...
    public static final BitSet FOLLOW_cosine_in_membership_function2791 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_dsigm_in_membership_function2795 = new BitSet(new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_COSINE_in_cosine2802 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004400000000L });
    public static final BitSet FOLLOW_atom_in_cosine2805 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004400000000L });
    public static final BitSet FOLLOW_atom_in_cosine2807 = new BitSet(new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_DSIGM_in_dsigm2813 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004400000000L });
    public static final BitSet FOLLOW_atom_in_dsigm2816 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004400000000L });
    public static final BitSet FOLLOW_atom_in_dsigm2818 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004400000000L });
    public static final BitSet FOLLOW_atom_in_dsigm2820 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004400000000L });
    public static final BitSet FOLLOW_atom_in_dsigm2822 = new BitSet(new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_GAUSS_in_gauss2828 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004400000000L });
    public static final BitSet FOLLOW_atom_in_gauss2831 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004400000000L });
    public static final BitSet FOLLOW_atom_in_gauss2833 = new BitSet(new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_GAUSS2_in_gauss22839 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004400000000L });
    public static final BitSet FOLLOW_atom_in_gauss22842 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004400000000L });
    public static final BitSet FOLLOW_atom_in_gauss22844 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004400000000L });
    public static final BitSet FOLLOW_atom_in_gauss22846 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004400000000L });
    public static final BitSet FOLLOW_atom_in_gauss22848 = new BitSet(new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_GBELL_in_gbell2854 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004400000000L });
    public static final BitSet FOLLOW_atom_in_gbell2857 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004400000000L });
    public static final BitSet FOLLOW_atom_in_gbell2859 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004400000000L });
    public static final BitSet FOLLOW_atom_in_gbell2861 = new BitSet(new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_points_in_piece_wise_linear2868 = new BitSet(
            new long[] { 0x0000000000000002L, 0x0000000000080000L });
    public static final BitSet FOLLOW_SIGM_in_sigm2876 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004400000000L });
    public static final BitSet FOLLOW_atom_in_sigm2879 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004400000000L });
    ...
    public static final BitSet FOLLOW_SINGLETONS_in_singletons2894 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000000080000L });
    public static final BitSet FOLLOW_points_in_singletons2898 = new BitSet(
            new long[] { 0x0000000000000002L, 0x0000000000080000L });
    public static final BitSet FOLLOW_TRAPE_in_trape2907 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004400000000L });
    public static final BitSet FOLLOW_atom_in_trape2910 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004400000000L });
    public static final BitSet FOLLOW_atom_in_trape2912 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004400000000L });
    public static final BitSet FOLLOW_atom_in_trape2914 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004400000000L });
    public static final BitSet FOLLOW_atom_in_trape2916 = new BitSet(new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_TRIAN_in_trian2922 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004400000000L });
    public static final BitSet FOLLOW_atom_in_trian2925 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004400000000L });
    public static final BitSet FOLLOW_atom_in_trian2927 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004400000000L });
    public static final BitSet FOLLOW_atom_in_trian2929 = new BitSet(new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_LEFT_PARENTHESIS_in_points2936 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004400000000L });
    public static final BitSet FOLLOW_atom_in_points2940 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000000004000L });
    public static final BitSet FOLLOW_COMMA_in_points2942 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004400000000L });
    public static final BitSet FOLLOW_atom_in_points2946 = new BitSet(
    ...
    public static final BitSet FOLLOW_FUNCTION_in_function3019 = new BitSet(
            new long[] { 0x4000180100100100L, 0x0000004400080002L });
    public static final BitSet FOLLOW_fun_pm_in_function3022 = new BitSet(new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_fun_md_in_fun_pm3028 = new BitSet(
            new long[] { 0x0000000000000002L, 0x0000000000500000L });
    public static final BitSet FOLLOW_PLUS_in_fun_pm3032 = new BitSet(
            new long[] { 0x4000180100100100L, 0x0000004400080002L });
    public static final BitSet FOLLOW_MINUS_in_fun_pm3037 = new BitSet(
            new long[] { 0x4000180100100100L, 0x0000004400080002L });
    public static final BitSet FOLLOW_fun_md_in_fun_pm3042 = new BitSet(
            new long[] { 0x0000000000000002L, 0x0000000000500000L });
    public static final BitSet FOLLOW_fun_mp_in_fun_md3055 = new BitSet(
            new long[] { 0x0000000000000002L, 0x000000000C000000L });
    public static final BitSet FOLLOW_STAR_in_fun_md3059 = new BitSet(
            new long[] { 0x4000180100100100L, 0x0000004400080002L });
    public static final BitSet FOLLOW_SLASH_in_fun_md3064 = new BitSet(
            new long[] { 0x4000180100100100L, 0x0000004400080002L });
    public static final BitSet FOLLOW_fun_mp_in_fun_md3068 = new BitSet(
            new long[] { 0x0000000000000002L, 0x000000000C000000L });
    public static final BitSet FOLLOW_fun_atom_in_fun_mp3082 = new BitSet(
            new long[] { 0x0000000000000002L, 0x0000000000220000L });
    public static final BitSet FOLLOW_HAT_in_fun_mp3086 = new BitSet(
            new long[] { 0x4000180100100100L, 0x0000004400080002L });
    public static final BitSet FOLLOW_PERCENT_in_fun_mp3091 = new BitSet(
            new long[] { 0x4000180100100100L, 0x0000004400080002L });
    public static final BitSet FOLLOW_fun_atom_in_fun_mp3095 = new BitSet(
            new long[] { 0x0000000000000002L, 0x0000000000220000L });
    public static final BitSet FOLLOW_atom_in_fun_atom3109 = new BitSet(new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_EXP_in_fun_atom3114 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000000080000L });
    public static final BitSet FOLLOW_LN_in_fun_atom3117 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000000080000L });
    public static final BitSet FOLLOW_LOG_in_fun_atom3120 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000000080000L });
    public static final BitSet FOLLOW_SIN_in_fun_atom3123 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000000080000L });
    public static final BitSet FOLLOW_COS_in_fun_atom3126 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000000080000L });
    public static final BitSet FOLLOW_TAN_in_fun_atom3129 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000000080000L });
    public static final BitSet FOLLOW_ABS_in_fun_atom3132 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000000080000L });
    public static final BitSet FOLLOW_LEFT_PARENTHESIS_in_fun_atom3137 = new BitSet(
            new long[] { 0x4000180100100100L, 0x0000004400080002L });
    public static final BitSet FOLLOW_fun_pm_in_fun_atom3140 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000001000000L });
    public static final BitSet FOLLOW_RIGHT_PARENTHESIS_in_fun_atom3142 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_DEFUZZIFY_in_defuzzify_block3153 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004000000000L });
    public static final BitSet FOLLOW_ID_in_defuzzify_block3156 = new BitSet(
            new long[] { 0x0200400028200000L, 0x0000000000000004L });
    public static final BitSet FOLLOW_defuzzify_item_in_defuzzify_block3159 = new BitSet(
            new long[] { 0x0200400028200000L, 0x0000000000000004L });
    public static final BitSet FOLLOW_END_DEFUZZIFY_in_defuzzify_block3163 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_defuzzification_method_in_defuzzify_item3171 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_default_value_in_defuzzify_item3175 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_linguistic_term_in_defuzzify_item3179 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_range_in_defuzzify_item3183 = new BitSet(new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_RANGE_in_range3190 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000000001000L });
    public static final BitSet FOLLOW_ASSIGN_OPERATOR_in_range3193 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000000080000L });
    public static final BitSet FOLLOW_LEFT_PARENTHESIS_in_range3196 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000400000000L });
    public static final BitSet FOLLOW_REAL_in_range3199 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000000010000L });
    public static final BitSet FOLLOW_DOTS_in_range3201 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000400000000L });
    public static final BitSet FOLLOW_REAL_in_range3204 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000001000000L });
    public static final BitSet FOLLOW_RIGHT_PARENTHESIS_in_range3206 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000002000000L });
    public static final BitSet FOLLOW_SEMICOLON_in_range3209 = new BitSet(new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_METHOD_in_defuzzification_method3217 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000000002000L });
    public static final BitSet FOLLOW_COLON_in_defuzzification_method3220 = new BitSet(
            new long[] { 0x04040400000E8000L });
    public static final BitSet FOLLOW_set_in_defuzzification_method3223 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000002000000L });
    public static final BitSet FOLLOW_SEMICOLON_in_defuzzification_method3239 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_DEFAULT_in_default_value3247 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000000001000L });
    public static final BitSet FOLLOW_ASSIGN_OPERATOR_in_default_value3250 = new BitSet(
            new long[] { 0x0008000000000000L, 0x0000000400000000L });
    public static final BitSet FOLLOW_set_in_default_value3253 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000002000000L });
    public static final BitSet FOLLOW_SEMICOLON_in_default_value3261 = new BitSet(new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_RULEBLOCK_in_rule_block3271 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004000000000L });
    ...
    public static final BitSet FOLLOW_operator_definition_in_rule_item3289 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_activation_method_in_rule_item3293 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_accumulation_method_in_rule_item3297 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_rule_in_rule_item3301 = new BitSet(new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_operator_definition_or_in_operator_definition3308 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_operator_definition_and_in_operator_definition3312 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_OR_in_operator_definition_or3319 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000000002000L });
    public static final BitSet FOLLOW_COLON_in_operator_definition_or3322 = new BitSet(
            new long[] { 0x0002200004805000L });
    public static final BitSet FOLLOW_set_in_operator_definition_or3325 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000002000000L });
    public static final BitSet FOLLOW_SEMICOLON_in_operator_definition_or3339 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_AND_in_operator_definition_and3347 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000000002000L });
    public static final BitSet FOLLOW_COLON_in_operator_definition_and3350 = new BitSet(
            new long[] { 0x0101800201002000L });
    public static final BitSet FOLLOW_set_in_operator_definition_and3353 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000002000000L });
    public static final BitSet FOLLOW_SEMICOLON_in_operator_definition_and3367 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_ACT_in_activation_method3375 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000000002000L });
    public static final BitSet FOLLOW_COLON_in_activation_method3378 = new BitSet(new long[] { 0x0100800000000000L });
    public static final BitSet FOLLOW_set_in_activation_method3381 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000002000000L });
    public static final BitSet FOLLOW_SEMICOLON_in_activation_method3387 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_ACCU_in_accumulation_method3395 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000000002000L });
    public static final BitSet FOLLOW_COLON_in_accumulation_method3398 = new BitSet(
            new long[] { 0x00A0200000004000L, 0x0000000000000001L });
    public static final BitSet FOLLOW_set_in_accumulation_method3401 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000002000000L });
    public static final BitSet FOLLOW_SEMICOLON_in_accumulation_method3413 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_RULE_in_rule3421 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004400000000L });
    public static final BitSet FOLLOW_rule_name_in_rule3424 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000000002000L });
    public static final BitSet FOLLOW_COLON_in_rule3426 = new BitSet(new long[] { 0x0000010000000000L });
    public static final BitSet FOLLOW_if_clause_in_rule3429 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000000000008L });
    public static final BitSet FOLLOW_then_clause_in_rule3431 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000002000200L });
    public static final BitSet FOLLOW_with_in_rule3434 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000002000000L });
    ...
    public static final BitSet FOLLOW_IF_in_if_clause3458 = new BitSet(
            new long[] { 0x0010000000000000L, 0x0000004000080000L });
    public static final BitSet FOLLOW_condition_in_if_clause3461 = new BitSet(new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_THEN_in_then_clause3468 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004000000000L });
    ...
    public static final BitSet FOLLOW_AND_in_condition3482 = new BitSet(
            new long[] { 0x0010000000000000L, 0x0000004000080000L });
    public static final BitSet FOLLOW_OR_in_condition3485 = new BitSet(
            new long[] { 0x0010000000000000L, 0x0000004000080000L });
    public static final BitSet FOLLOW_subcondition_in_condition3489 = new BitSet(new long[] { 0x0040000000000802L });
    public static final BitSet FOLLOW_NOT_in_subcondition3499 = new BitSet(
            new long[] { 0x0010000000000000L, 0x0000004000080000L });
    public static final BitSet FOLLOW_subcondition_bare_in_subcondition3505 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_subcondition_paren_in_subcondition3509 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_ID_in_subcondition_bare3517 = new BitSet(new long[] { 0x0000020000000002L });
    public static final BitSet FOLLOW_IS_in_subcondition_bare3521 = new BitSet(
            new long[] { 0x0010000000000000L, 0x0000004000000000L });
    public static final BitSet FOLLOW_NOT_in_subcondition_bare3525 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004000000000L });
    public static final BitSet FOLLOW_ID_in_subcondition_bare3529 = new BitSet(new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_LEFT_PARENTHESIS_in_subcondition_paren3539 = new BitSet(
            new long[] { 0x0010000000000000L, 0x0000004000080000L });
    public static final BitSet FOLLOW_condition_in_subcondition_paren3542 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000001000000L });
    public static final BitSet FOLLOW_RIGHT_PARENTHESIS_in_subcondition_paren3544 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_sub_conclusion_in_conclusion3552 = new BitSet(
            new long[] { 0x0000000000000002L, 0x0000000000004000L });
    public static final BitSet FOLLOW_COMMA_in_conclusion3555 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004000000000L });
    public static final BitSet FOLLOW_sub_conclusion_in_conclusion3558 = new BitSet(
            new long[] { 0x0000000000000002L, 0x0000000000004000L });
    public static final BitSet FOLLOW_ID_in_sub_conclusion3567 = new BitSet(new long[] { 0x0000020000000000L });
    public static final BitSet FOLLOW_IS_in_sub_conclusion3570 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000004000000000L });
    public static final BitSet FOLLOW_ID_in_sub_conclusion3573 = new BitSet(new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_WITH_in_with3579 = new BitSet(
            new long[] { 0x0000000000000000L, 0x0000000400000000L });
