...
public abstract class DefuzzifierContinuous extends Defuzzifier {
    ...
    private double max; // Where function ends
    private double min; // Where function begins
    ...
    protected void init() {
        ...
        if (values == null || values.length != numberOfPoints) {
        ...
        if (umin > umax) {
            throw new RuntimeException(
                    "Parameter max is out of range (should satisfy: min < max). min: " + umin + "\tmax: " + umax);
        }
