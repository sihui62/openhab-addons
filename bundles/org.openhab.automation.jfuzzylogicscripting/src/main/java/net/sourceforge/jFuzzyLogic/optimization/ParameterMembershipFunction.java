...
public class ParameterMembershipFunction extends Parameter {
     ...
     */
    public ParameterMembershipFunction(String name, double epsilon, Variable variable,
            MembershipFunction membershipFunction, int parameterIndex) {
        super(name, epsilon);
    ...
    public boolean set(double value) {
        ...
        if (value < variable.getUniverseMin())
            return false;
        if (value > variable.getUniverseMax())
            return false;
