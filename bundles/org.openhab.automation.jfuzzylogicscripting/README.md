# Fuzzy Logic Scripting

This add-on provides support for [jFuzzyLogic](https://jfuzzylogic.sourceforge.net/html/index.html) that can be used as a scripting language within automation rules.
